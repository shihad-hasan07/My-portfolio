...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className={`py-5 px-6 md:px-16 lg:px-32 border-b-[1px] border-b-[#332142] flex items-center justify-between gap-9 w-full z-50 text-white bg-[#150c1d] transition-all duration-500 ease-in-out ${
                isScrolled
