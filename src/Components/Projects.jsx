                        ...
                        <div className="relative group rounded-xl shadow-lg min-h-[400px] ">
                            ...
                            <div className="relative ">
                                <img
                                    ...
                                    className="w-full h-48 object-cover pb-2 transition duration-200 group-hover:blur-xs group-hover:brightness-75" />
                            ...
                            {/* Card Content */}
                            <div className="px-4 pb-5 bg-blue-950 text-white flex flex-col justify-between">
